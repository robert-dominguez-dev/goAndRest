...
const cyborgCs: WorkoutSoundFilePaths = {
  [RunningWorkoutPhase.WARMUP]: {
    standard: [require('./cs/cyborg_cs_warmup.mp3')],
  },
  [RunningWorkoutPhase.WORK]: {
    standard: [require('./cs/cyborg_cs_work.mp3')],
  },
  [RunningWorkoutPhase.REST]: {
    standard: [require('./cs/cyborg_cs_rest.mp3')],
  },
  [RunningWorkoutPhase.RECOVERY]: {
    standard: [require('./cs/cyborg_cs_recovery.mp3')],
  },
  [RunningWorkoutPhase.COOLDOWN]: {
    standard: [require('./cs/cyborg_cs_cooldown.mp3')],
  },
  ...
  half: {
    standard: [require('./cs/cyborg_cs_half.mp3')],
  },
  finish: {
    standard: [require('./cs/cyborg_cs_finish.mp3')],
  },
};
