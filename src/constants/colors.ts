...
export const appColorsLight = {
  ...
  text: appDesignSystemColors.grayscale['600'],
  ...
  infoHintText: appDesignSystemColors.grayscale['600'],
  infoHintBackground: appDesignSystemColors.grayscale['200'],
  alert: '#8a6d05',
  alertBackground: '#f8e7a8',
  error: '#c20d1e',
  errorBackground: '#f8c3c9',
  ...
  premium: '#C99700',
  premiumSemiTransparent: '#C9970030',
  onPremium: '#111111',
  semiTransparentBackground: '#eeeeee73',
  work: '#f38181',
  workStrong: '#d83535',
  workPhase: '#bf0202',
  rest: '#75e8d3',
  ...
  rounds: '#cccccc',
  recovery: '#ecd883',
  recoveryStrong: '#a68705',
  recoveryPhase: '#a68705',
  warmup: '#e69d6c',
  warmupPhase: '#ba5604',
  cooldown: '#a1d9e4',
  cooldownPhase: '#017a8f',
  male: '#0197d6',
  female: '#ea11dd',
...
export const appColorsDark = {
  ...
  infoHintText: appDesignSystemColors.grayscale['200'],
  infoHintBackground: appDesignSystemColors.grayscale['600'],
  alert: '#e0c14a',
  alertBackground: '#3d3308',
  error: '#ff9aa4',
  errorBackground: '#40121a',
  ...
  selectedItem: appDesignSystemColors.primary['400'],
  premium: '#a58903',
  premiumSemiTransparent: '#a5890320',
  onPremium: '#111111',
  semiTransparentBackground: '#11111173',
  work: '#d5253f',
  workStrong: '#df213d',
  workPhase: '#d5253f',
  rest: '#10a590',
  ...
  recovery: '#a18703',
  recoveryStrong: '#cfaf0c',
  recoveryPhase: '#a18703',
  warmup: '#c86d25',
  warmupPhase: '#c86d25',
  cooldown: '#2699ae',
  cooldownPhase: '#2699ae',
  male: '#00b4ff',
  female: '#ea11dd',
